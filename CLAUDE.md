...
**La coordination est TRICÉPHALE.** Trois têtes : le **coordinateur** `myia-ai-01:CoursIA` (merge, clôture, arbitrage, skill `coordinate`) ; le **titulaire** `myia-po-2025:CoursIA-2` (dossiers `[ADJOINT PREFLIGHT]` exact-head, skill `coordinate-adjoint`) ; le **secrétaire** `myia-po-2026:CoursIA-3` (HUB DE CIRCULATION, skill `adjoint-secretary`, artefact **`workspace-CoursIA-3`**). Le « secrétariat » et le « troisième dashboard » désignent **toujours** ce dernier — il n'y a rien à chercher. Détail : [tricéphale-circulation.md](.claude/rules/tricéphale-circulation.md).
