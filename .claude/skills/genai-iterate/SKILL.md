...
```
- comfyui-qwen : GPU0 ~20GB, Bearer (`COMFYUI_API_TOKEN`, alias `COMFYUI_AUTH_TOKEN`). forge-turbo : GPU1 ~8GB, Basic (`FORGE_USER`/`FORGE_PASSWORD`). vllm-zimage : GPU1 ~15GB, no auth.
