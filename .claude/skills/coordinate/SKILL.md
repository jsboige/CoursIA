...
5. **Ledger de dette partage** : rafraichir `issue-debt` en pliant l'export du journal + le snapshot precedent comme checkpoint (`python scripts/coordination/debt_ledger.py reduce`, Phase 3 bis). Les observations des lanes arrivent par le dashboard dedie ; le snapshot n'est ecrit que par ai-01.
