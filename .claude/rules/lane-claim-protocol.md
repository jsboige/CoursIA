...
7. **Lire les DEUX dashboards avant de provisionner** (R3 [coordinator-discipline.md](coordinator-discipline.md)) — nécessaire mais insuffisant seul : il ne couvre pas la fenêtre inter-cycle, d'où les points 5-6. **Le troisième dashboard** — `workspace-CoursIA-3` (le secrétariat) — **n'entre PAS dans cette lecture binaire** : il a son propre tour (DMs nominatifs, alertes conflits/quota/runners) et se lit à part, ou en réaction à un DM nominatif qu'il a posté sur l'inbox. Voir [tricéphale-circulation.md](../../docs/reference/tricephale-circulation.md) §« Pivot R3 ».
