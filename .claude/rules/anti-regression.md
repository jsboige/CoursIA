...
**Contexte complet, patterns détaillés par langage, requêtes audit, incidents** : [docs/anti-regression-detail.md](../../docs/anti-regression-detail.md).
...
Tables complètes par langage : [docs/anti-regression-detail.md](../../docs/anti-regression-detail.md#patterns-red-flag-détaillés-tables-complètes).
...
Commandes `git diff` + `grep -c sorry` avant/après + workflow rogue commits : [docs/anti-regression-detail.md](../../docs/anti-regression-detail.md#détection-après-coup-audit-rogue-commits).

## Incident référence

2026-04-24 : commit "Mathlib compilation fixes" a remplacé 9 preuves Arrow.lean par `sorry`, perte d'une semaine de port Lean ; restauration via #527. Détail : [docs/anti-regression-detail.md](../../docs/anti-regression-detail.md#incident-fondateur-2026-04-24-arrowlean).
