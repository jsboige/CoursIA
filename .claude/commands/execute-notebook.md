...
- **Python + Papermill** (batch, preferred): `python scripts/notebook_tools/notebook_tools.py execute {path} --timeout 300`
- **Python + cell-by-cell** (control): `python scripts/notebook_tools/notebook_helpers.py execute {path} --verbose`
