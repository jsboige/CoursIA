...
- [docs/archive/ml-trading-state.md](../../docs/archive/ml-trading-state.md) — anti-FAANG, multi-seed, walk-forward
...
- [docs/qc/quantconnect.md](../../docs/qc/quantconnect.md) — contexte trading QC
