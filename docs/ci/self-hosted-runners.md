...
- **Aucune dégradation médiane détectée** : p50 seul 0.367 min, p50 partagé 0.267 min (ratio 0.727). À ne pas sur-lire : la population « seule » ne compte que 5 jobs, et ce premier verdict ne rapporte pas la queue de distribution (p90/max) — il établit l'absence de signal au median, pas l'absence de coût de co-résidence sur les jobs longs.
