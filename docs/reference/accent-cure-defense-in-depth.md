...
| **GATE caps** | `detect_caps_regression.py` | Caps-regression (markdown prose) | PR #7198 **MERGÉ** (#7197 CLOSED, contenu absorbé en git-ref mode) |
