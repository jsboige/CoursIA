...
État au **2026-09-25** (comptage `git ls-files` sur `origin/main` : **14** emplacements, la liste de 2026-08 en recensait 11 — `GenAI/Audio`, `docker-configurations` et `notebook_tools` sont apparus depuis) :
...
| `MyIA.AI.Notebooks/SymbolicAI/Lean/scripts/_archive/` | ✅ | ✅ (registre, 30 lignes de table) |
...
| `scripts/notebook_tools/_archive/` | ✅ | partiel (2 fichiers) |
| `scripts/sudoku/_archive/` | ✅ | ✅ (tranche #13749 du 2026-09-25 : registre 4 colonnes ; les 6 en-têtes existaient déjà) |
| `slides/S4-trading-algorithmique/_archive/` | ✅ | ✅ (registre, 6 lignes de table) |
