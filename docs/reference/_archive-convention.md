...
## Application — 14 emplacements

État au **2026-09-25** (comptage `git ls-files` : **14** emplacements ; la liste de 2026-08 en recensait 11 — `GenAI/Audio`, `docker-configurations` et `notebook_tools` n'y figuraient pas) :

| Emplacement | README | Standard complet |
|---|---|---|
| `MyIA.AI.Notebooks/QuantConnect/ML-Training-Pipeline/scripts/_archive/` | ✅ | ✅ (modèle) |
| `MyIA.AI.Notebooks/GenAI/Audio/_archive/` | ✅ | ✅ (1 notebook — registre README, disposition par section ; tranche #13749 du 2026-09-25) |
| `MyIA.AI.Notebooks/Search/_archive/` | ✅ | partiel (2 notebooks) |
| `MyIA.AI.Notebooks/SymbolicAI/_archive/` | ✅ | partiel (1 fichier) |
| `MyIA.AI.Notebooks/SymbolicAI/Lean/scripts/_archive/` | ✅ | ✅ (registre, 26 lignes de table) |
...
| `scripts/genai-stack/_archive/` | ❌ | tranche 3 (28 fichiers constatés au 2026-08, peut nécessiter split) — **à la lane `myia-po-2027:CoursIA-2`** (claim scoped `{core,utils}`) |
| `scripts/notebook_tools/_archive/` | ✅ | partiel (1 fichier) |
| `scripts/sudoku/_archive/` | ✅ | ✅ (tranche #13749 du 2026-09-25 : registre 4 colonnes ; les 6 en-têtes existaient déjà) |
| `slides/S4-trading-algorithmique/_archive/` | ✅ | ✅ (registre, 4 lignes de table) |
| `docker-configurations/_archive-20251125/` | ✅ | non audité (10 fichiers) |
