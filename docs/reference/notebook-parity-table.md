...
| **Search (racine + Part1-4)** | `MyIA.AI.Notebooks/Search/` | ≈40 racine + Part1 (≈16) + Part2-CSP (≈14) + Part4-Metaheuristics | **P-OK partiel** | cs-ipy + py-ipy | D-moyen | Choco (IKVM 11) + OrTools + MGS + HeuristicLab | po-2025 | Audité #5081 (P7 frontière floue racine/sous-dossier). Cible #4956 : accessible **entièrement** |
