...
**Cas concret instrumenté.** [ICT-01-PhiTrajectories](../../MyIA.AI.Notebooks/IIT/ICT-Series/ICT-01-PhiTrajectories.ipynb) : $\Phi$ comme invariant mesuré cross-substrat, suivi le long d'un attracteur. La trajectoire de $\Phi$ est ce qu'on cherche à transporter d'un substrat à l'autre — la *photographie IIT mise en mouvement*. Ce régime demande : *existe-t-il, à travers les substrats, une grandeur dont la trajectoire se recolle ?* La réponse honnête de la série est **non** — et ce non est précisément ce qui fait basculer dans le régime 3 (obstruction).
