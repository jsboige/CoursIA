...
**Generated** : 2026-09-13T11:15:55.171684+00:00
**Workflows dir** : `C:\dev\CoursIA-15962\.github\workflows`
...
|---|---|
| Total workflows | 161 |
| Avec `pull_request` trigger | 90 |
| **Avec filtre paths/paths-ignore** | **84** |
| Sans filtre | 6 |
| - dont required (gates/advisories) | 4 |
| - dont exemptions documentees | 1 |
| - dont filtre par la base (cible != main) | 1 |
| - dont eligible (a investiguer) | 0 |
| Sans `pull_request` trigger | 71 |
...
### Exemptions documentees (decision ecrite, pas un oubli)

- `notebook-plan-loss-gate.yml` — #14391/#14429

### Filtre par la base (cible != main, #15165)
...
| `dotnet-AgentSafetyAnalyzer.yml` | 3 |
| `dotnet-ArgumentAnalysis.yml` | 3 |
| `dotnet-OrphanApps.yml` | 5 |
| `dotnet-Shared.Tests.yml` | 3 |
| `dryrun-sizing-control.yml` | 2 |
| `enrich-quality-gate.yml` | 3 |
| `gametheory-tests.yml` | 2 |
| `harness-coauthor-guard.yml` | 7 |
| `hooks-parity.yml` | 4 |
| `ict-tests-profile.yml` | 1 |
| `ict-tests.yml` | 2 |
...
| Metrique | Valeur |
|---|---|
| Workflows PR clonant sans clone partiel | **11** |
| - conformes (blob:none present) | 21 |
| - exclus (clone complet necessaire) | 1 |
| Machines a clone (PR trigger + fetch-depth: 0) | 33 |
