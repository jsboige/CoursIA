...
La theorie des jeux donne d'ailleurs a voir le continuum sans detour : l'existence de Nash *prouvee* en Lean ([`GameTheory-4b`](../MyIA.AI.Notebooks/GameTheory/GameTheory-4b-Lean-NashExistence.ipynb)) et la meme existence *constatee* numeriquement en Python ([`GameTheory-4c`](../MyIA.AI.Notebooks/GameTheory/GameTheory-4-NashEquilibrium.ipynb)) ne sont pas au meme cran, bien que ce soit le meme theoreme. Changer de representation, ce n'est pas seulement changer de cout : c'est changer de garantie.
