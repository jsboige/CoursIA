...
| 3 | Search-10 (C#) : Automates Finis Classiques — jumeau .N | BETA | Oui |
| 4 | Search-10 : Automates Symboliques avec Z3 | BETA | Oui |
| 5 | Search-11 (C#) : Métaheuristiques — Optimisation par es | BETA | Oui |
...
| 10 | Search-11b : Métaheuristiques d'optimisation (C# / .NET | BETA | Oui |
| 11 | Search-15 : Théorie des Graphes avec NetworkX (C#) | BETA | Oui |
| 12 | Search-15-NetworkX : Algorithmes de Graphe avec Network | BETA | Oui |
...
| 15 | Search-2-Uninformed : Algorithmes de Recherche Non Info | BETA | Oui |
...
| 19 | Search-4-LocalSearch : Recherche Locale et métaheuristi | BETA | Oui |
| 20 | Search-5-GeneticAlgorithms-Csharp : Algorithmes Génétiq | BETA | Oui |
...
| # | Notebook | Maturité | Exécutable |
|---|----------|----------|------------|
| 1 | CSP-1 : Fondamentaux des CSP - Version .NET (Choco-solv | BETA | Oui |
| 2 | CSP-1 : Fondamentaux des CSP | BETA | Oui |
| 3 | CSP-2 : Propagation de Contraintes et Consistance - Ver | BETA | Oui |
| 4 | CSP-2 : Propagation de Contraintes et Consistance | BETA | Oui |
| 5 | CSP-3 : CSP Avancé — Contraintes globales et stratégies | BETA | Oui |
| 6 | CSP-3 : CSP Avance - Contraintes globales, OR-Tools et  | BETA | Oui |
| 7 | CSP-4-Scheduling-Csharp : Problèmes d'Ordonnancement av | BETA | Oui |
| 8 | CSP-4-Scheduling : Problèmes d'Ordonnancement | BETA | Oui |
| 9 | CSP-5-Optimization-Csharp : Optimisation Combinatoire a | BETA | Oui |
| 10 | CSP-5-Optimization : Problèmes d'Optimisation Combinato | BETA | Oui |
| 11 | CSP-6-Hybridation : Approches Hybrides Modernes (.NET / | BETA | Non |
| 12 | CSP-6-Hybridation : Approches Hybrides Modernes | BETA | Non |
| 13 | CSP-7 : Contraintes Souples avec Choco-solver | BETA | Oui |
| 14 | CSP-7 : Contraintes Souples - Soft CSP | BETA | Non |
| 15 | CSP-8 : Temporels - Raisonnement sur le Temps | BETA | Oui |
| 16 | CSP-8 : Temporels - Raisonnement sur le Temps | BETA | Non |
| 17 | CSP-9-Distributed : CSP Distribués (DisCSP)**Navigation | BETA | Oui |
| 18 | CSP-9-Distributed : CSP Distribués (DisCSP) | BETA | Oui |
...
| 3 | Search-13 (C#) — Recherche à écart limité (Limited Disc | BETA | Oui |
| 4 | Search-13 — Recherche à écart limité (Limited Discrepan | BETA | Oui |
| 5 | Search-14 (C#) — Weighted A\* : recherche à sous-optima | BETA | Oui |
...
| # | Notebook | Maturité | Exécutable |
|---|----------|----------|------------|
| 1 | MGS-1 : Introduction a MetaGeneticSharp et au moteur au | BETA | Oui |
...
| 5 | MGS-15 : Analyse de paysage -- la corrélation fitness-d | BETA | Oui |
| 6 | MGS-16-AlgorithmSelection : Sélectionner le bon optimis | BETA | Oui |
| 7 | MGS-17 — Contrôle de paramètres (Parameter Control) | BETA | Oui |
| 8 | MGS-18 — Banc CEC consolide : la combinaison des deux b | BETA | Oui |
| 9 | MGS-19 — Recuit simulé décomposé : l'opérateur de Metro | BETA | Oui |
...
| 13 | MGS-7d : Michalewicz (steep ridges) + Dixon-Price (narr | BETA | Oui |
...
| 10 | Sudoku-13 : Le Sudoku comme Regex Symbolique - l'échell | BETA | Oui |
| 11 | Sudoku-13 : Le Sudoku comme Regex Symbolique — twin Pyt | BETA | Oui |
| 12 | Sudoku-14 : Automates avec BDD/MDD - Approche Pure | BETA | Oui |
| 13 | Sudoku-14 : Automates avec BDD/MDD - Approche Pure (Pyt | BETA | Oui |
| 14 | Résolution de Sudoku avec Infer.NET | BETA | Oui |
| 15 | Sudoku-15-Infer-Python : Resolution Probabiliste avec N | BETA | Oui |
