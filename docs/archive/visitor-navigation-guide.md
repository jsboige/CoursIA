...
**Entree recommandee** : [Search-01-StateSpace](../MyIA.AI.Notebooks/Search/Part1-Foundations/Search-01-StateSpace.ipynb) formalise les espaces d'etats, le concept fondateur commun a toute la serie.
...
**Entree recommandee** : [Lean-1-Setup](../MyIA.AI.Notebooks/SymbolicAI/Lean/Lean-1-Setup.ipynb) configure l'environnement Lean 4 (kernel WSL). Puis [Tweety-2](../MyIA.AI.Notebooks/SymbolicAI/Tweety/Tweety-02-Basic-Logics-Python.ipynb) pour les fondamentaux logiques.
...
| **Incertitude** | [PyMC-01-Setup](../MyIA.AI.Notebooks/Probas/PyMC/PyMC-01-Setup.ipynb) (echantillonnage MCMC) | [Infer-101](../MyIA.AI.Notebooks/Probas/Infer-101.ipynb) (inference exacte par message-passing) |
