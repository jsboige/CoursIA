/-
  ...
  `SocialChoice_en.lean` (variante redeclare-in-namespace : il redéclare
  l'intégralité du module dans `namespace SocialChoiceEn`, autonome — aucun
  ...
  déclarations) diffèrent, FR dans ce fichier, EN dans `SocialChoice_en.lean`.
-/
