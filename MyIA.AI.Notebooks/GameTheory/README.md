...
| 2d | [GameTheory-02d-Travelers-Dilemma-Csharp](GameTheory-02d-Travelers-Dilemma-Csharp.ipynb) | C# (.NET) | **Jumeau C# de 2c** (maturation Chantier 5) : paiement, meilleure réponse, élimination itérée, seuil r* = 1 et contre-claim de fragilité re-dérivés dans un second moteur — parité numérique complète avec 2c, deux implicites nommés (tie-breaking de l'argmax, cas limite r = 1 où la spirale roule sans rapporter) | 40 min |
