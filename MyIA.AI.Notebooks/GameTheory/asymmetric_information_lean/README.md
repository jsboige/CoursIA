...
|---|---|---|
| Lemons (marché des voitures d'occasion) | `AsymmetricInformation.Lemons` | Akerlof (1970) *QJE* 83(3):488-500 |
...
python scripts/lean/count_code_sorry.py --json   # distinct_code_sorry=3 (bornés)
