...
<!-- CATALOG-STATUS
series: Search
pedagogical_count: 112
breakdown: Applications=40, Part1-Foundations=29, Part4-Metaheuristics=19, Part2-CSP=18, Part3-Advanced=6
maturity: PRODUCTION=85, BETA=27
-->
...
| --- | --- | --- | --- |
| **Part 1 — Fondements** (`Part1-Foundations/`) | **29** (16 Python : Search-1 → Search-11, 15 + déclinaison deep-dive **Search-11b en 4 volets** Python + **13 C#** : jumeaux Search-1 à 11 et 15 + Search-16 QuikGraph natif) | Python + .NET (C#) | StateSpace, BFS/DFS/UCS/IDDFS, A*, Local Search (SA/Tabu), GA, Minimax/Alpha-Beta, MCTS, DLX, LP, Symbolic Automata, métaheuristiques (PSO/ABC/BRO + 160+ MEALPy), NetworkX, QuikGraph |
