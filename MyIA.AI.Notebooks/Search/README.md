...
├── Part4-Metaheuristics/                  # Partie 4 (side track C# .NET 9) : README + 13 notebooks MGS-1..13 (moteur, composition, composés, benchmarks, TSP, paysages, biais central, synergie d'îles, alignement d'axes, paysages dé-biaisés ; consomment le sous-module)
│
