...
├── Part4-Metaheuristics/                  # Partie 4 (side track C# .NET 9) : README + 12 notebooks MGS-1..12 (moteur, composition, composés, benchmarks, TSP, paysages, biais central, synergie d'îles, alignement d'axes ; consomment le sous-module)
│
