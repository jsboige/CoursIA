...
breakdown: Applications=41, Part1-Foundations=29, Part4-Metaheuristics=22, Part2-CSP=18, Part3-Advanced=6
maturity: BETA=108, ALPHA=5, DRAFT=3
-->
...
| [Applications](Applications/) | 20 cas réels (App-1 à App-20) | Python + .NET | **20 binômes complets** (40 notebooks) + App-2 Validité statistique (41) |
...
| **Applications** (`Applications/`) | **41** (27 CSP + 10 Hybrid + 4 Search — **20 binômes Python ⇄ C#** App-1 à App-20, plus App-2 Validité statistique, Python supplémentaire sans jumeau) | 21 Python + 20 C# | N-Queens, Graph Coloring, Nurse/Job-Shop/Timetabling Scheduling, Minesweeper, Wordle, MiniZinc, Picross (27M× speedup), Sports/Crossword/WFC CSP, SudokuBenchmark, Portfolio/TSP/VRP/Hyperparameter Tuning, Edge Detection, ConnectFour (Minimax/MCTS) |
| **archive** (`_archive/`) | **1** (CSPs_Intro, historique pré-tranche 8/8 #5081) | Python | Notebook historique, remplacé par Part2-CSP/CSP-1-Fundamentals |
| **Total** | **116** (gît-tracked : 41 + 29 + 22 + 18 + 6 = 116 pédagogiques + 1 archive = 117) | Python + C# | 5 piliers + archive, voir « Structure des fichiers » pour l'arborescence complète |
