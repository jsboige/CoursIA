...
├── Part4-Metaheuristics/                  # Partie 4 (side track C# .NET 9) : README + 11 notebooks MGS-1..11 (moteur, composition, composés, benchmarks, TSP, paysages, biais central, synergie d'îles ; consomment le sous-module)
│
