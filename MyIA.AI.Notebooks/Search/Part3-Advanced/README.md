...
| Bibliothèques | `heapq` (tas) pour Search-12–14 — toutes dans [`requirements.txt`](../requirements.txt) de la série |
...
| Search-09c (théorème 2k−1) | Beck, J., & Fiala, T. (1981) — « Integer-making theorems », *Discrete Applied Mathematics* 3(1). Le théorème fondateur : disc ≤ 2k−1 pour les systèmes de degré k, par arrondi flottant. |
| Search-09c (preuve de référence) | Matoušek, J. (2002) — *Lectures on Discrete Geometry*, Springer, Ch. 1 (Thm 1.3.1). La preuve canonique de Beck–Fiala que le notebook implémente et mesure. |
| Search-09c (frontière 2025) | Bansal, N., & Jiang, H. (2025) — « Decoupling via Affine Spectral-Independence: Beck-Fiala and Komlós Bounds Beyond Banaszczyk », [arXiv:2508.03961](https://arxiv.org/abs/2508.03961). Résout la conjecture de Beck–Fiala pour k ≥ log²n ; Komlós Õ(log^{1/4} n) ; le geste du découplage spectral affine. |
