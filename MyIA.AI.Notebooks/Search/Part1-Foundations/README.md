...
| 3b | [Search-03b-NetworkX](Search-02b-NetworkX.html) | Python 3 | **Boîte à outils de graphes** `networkx` : `Graph`/`DiGraph`, DFS/BFS, Dijkstra, Bellman-Ford, centralités de degré, composantes connexes, MST, Floyd-Warshall, parité structurelle avec QuikGraph (Search-2c) — matière optionnelle, utile dès la fin de Search-2 (accretion de Search-3) | ~1h
| 3b (.NET) | [Search-03b-NetworkX (C#)](Search-02b-NetworkX-Csharp.ipynb) | .NET (C#) | **Jumeau .NET** : théorie des graphes from-scratch (`Dictionary` / adjacency list pondérée) — parcours BFS/DFS, plus courts chemins (Dijkstra), centralités, flot maximum (Ford-Fulkerson) — port C# fidèle du notebook Python NetworkX (accretion de Search-3) | ~1h
| 3c | [Search-03c-CombinatorialDiscrepancy](Search-09c-CombinatorialDiscrepancy.ipynb) | Python 3 | Discrépance combinatoire (Beck–Fiala 1981, frontière 2025 Bansal–Jiang arXiv:2508.03961) : colorier ±1 sans déséquilibrer, borne inf √k (Chernoff), arrondi flottant 2k−1 implémenté, CP-SAT en oracle exact — fil relaxation/arrondi/optimisation combinatoire (accretion de Search-3) | ~45min
| 3c (.NET) | [Search-03c-CombinatorialDiscrepancy (C#)](Search-09c-CombinatorialDiscrepancy.ipynb) | Python 3 | Discrépance combinatoire (accretion de Search-3) | ~45min
| 3d | [Search-03d-Lean-Discrepancy-Komlos](Search-09d-Lean-Discrepancy-Komlos.ipynb) | lean4-wsl | **Compagnon formel de Search-03c** : le lake `discrepancy_lean` exécuté depuis le kernel Lean 4 — `#check` des conjectures (Komlós ∃C universel, Beck–Fiala 2k−1), témoins énumérés, exercices ancrés sur les énoncés du lake (accretion de Search-3) | ~45min
| 3d (.NET) | [Search-03d-Lean-Discrepancy-Komlos (C#)](Search-09d-Lean-Discrepancy-Komlos.ipynb) | lean4-wsl | **Compagnon formel** : lake `discrepancy_lean` (accretion de Search-3) | ~45min
...
### Accretions avancées de Search-3 (ex-Partie 3)
