...
| 12 | [App-27-Sparse-Index-Tracking-Walk-Forward](Hybrid/App-27-Sparse-Index-Tracking-Walk-Forward.ipynb) | ~60 min | Sparse index tracking : lots entiers, cardinalité exacte, turnover temporel, validation indépendante, walk-forward sans fuite et audit d'un protocole contaminé — distillation PrCon M2 (Godric Bouteloup) | Projet étudiant (PrCon PR #52) |
