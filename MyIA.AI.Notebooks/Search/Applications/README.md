...
| 7d | [App-18c-HyperparameterTuning-Rustuna-vs-Optuna](Hybrid/App-18c-HyperparameterTuning-Rustuna-vs-Optuna.ipynb) | ~20 min | Rustuna vs Optuna : pont SOTA triple (Random numpy / Optuna TPE / Rustuna TPE) sur l'objectif k-NN CV d'App-18b, speedup mesuré deux régimes, audit d'une dépendance expérimentale (bug `best_trial` mesuré) | Nouveau |
