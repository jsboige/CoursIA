...
flowchart LR
    ...
    H["<b>Applications Hybrides</b> (10)<br/>EdgeDetection, Portfolio,<br/>TSP, VRP, Hyperparameter,<br/>AlgorithmSelection, PRESENT/SAT,<br/>audits MAPF, WDP/VCG et branching ML"]
    P1 --> S
    P2 --> C
    P4 --> H
