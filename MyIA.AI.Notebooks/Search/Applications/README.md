...
| 12 | [App-28-LearningToBranch-Generalization-Audit](Hybrid/App-28-LearningToBranch-Generalization-Audit.ipynb) | ~60 min | Learning to branch : imitation de dom/wdeg, séparation par instances, transfert inter-familles, performance intégrée et coût d'inférence — distillation PrCon G4 (Simon Naulet, Matis Codjia) | Projet étudiant (PrCon PR #46) |
