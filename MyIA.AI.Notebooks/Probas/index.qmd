...
listing:
  - id: infer-setup
    contents:
      - "Infer/Infer-1-Setup.ipynb"
      - "Infer/Infer-1b-Premiers-Modeles.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
  - id: infer-notebooks
    contents:
      - "Infer/Infer-[2-9]-*.ipynb"
      - "Infer/Infer-2b-*.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
  - id: infer-advanced
  ...
  - id: infer-frontiers
    ...
    page-size: 24
  - id: pymc-setup
    contents: "PyMC/PyMC-01-Setup.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
  - id: pymc-notebooks
    contents: "PyMC/PyMC-0[2-9]*.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
  - id: pymc-advanced
    ...
    page-size: 24
  - id: pymc-frontiers
    contents: "PyMC/PyMC-1[5-9]*.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
  - id: dt-infer
    contents: "DecisionTheory/DecInfer/DecInfer-*.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
  - id: dt-pymc
    contents: "DecisionTheory/DecPyMC/DecPyMC-*.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
  ...
  - id: standalone-root
    contents:
      - "Applications/Pyro_RSA_Hyperbole.ipynb"
      - "Applications/Percolation/Percolation-Supercritique.ipynb"
      - "Applications/Percolation/Percolation-Lean.ipynb"
      - "Infer/Infer-20-Quotients-et-Fibres.ipynb"
    type: grid
    sort: "filename"
    page-size: 24
---
...
| **[DecisionTheory/DecPyMC](DecisionTheory/DecPyMC/README.md) (Python)** | 7 | PyMC | Mêmes modèles de décision, en sampling |
...
**Parcours** : [Parcours 1 — local sobre](../../parcours.qmd) · niveau 2
...
Un notebook applicatif autonome, indépendant des deux arcs, vit dans [`Applications/`](Applications/) :
...
- **Séries connexes** :
  ...
  - [ML](../ML/README.md) — machine learning, où les modèles probabilistes (Gaussian Processes, LDA) rejoignent les modèles discriminatifs.
...
3. **Vers le machine learning discriminant** : [ML](../ML/README.md) — régression/probabilités conditionnelles, où les modèles probabilistes rejoignent le deep learning.
...
5. **Vers la simulation multi-agent** : [IIT](../IIT/README.md) — PyPhi, integrated information, où la théorie de la décision probabiliste alimente la théorie de l'information intégrée.
