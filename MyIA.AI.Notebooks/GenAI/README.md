...
<!-- CATALOG-STATUS
series: GenAI
pedagogical_count: 111
breakdown: Audio=28, SemanticKernel=20, Image=16, Video=16, Texte=11, 00-GenAI-Environment=6, Vibe-Coding=5, CaseStudies=4, FineTuning=4, =1
maturity: BETA=65, PRODUCTION=32, DRAFT=6, ALPHA=5, TEMPLATE=3
-->
