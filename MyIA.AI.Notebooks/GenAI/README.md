...
|---|-----------|--------|--------|-----------|
| 1 | 00-GenAI-Environment - Votre point de départ | [README complet](00-GenAI-Environment/README.md) | ~4h | Configuration Docker ComfyUI/Qwen, Whisper, MusicGen, Forge |
| 2 | Image - Générer, éditer et orchestrer des images | [README complet](Image/README.md) | ~6-8h | Construire un générateur de contenu visuel pour l'éducation |
| 3 | Audio - Parler, écouter, composer | [README complet](Audio/README.md) | ~14-16h | Produire un podcast automatique avec voix synthétique + fond musical |
| 4 | Video - Comprendre, générer et produire | [README complet](Video/README.md) | ~14h | Créer une vidéo pédagogique automatisée depuis un script texte |
| 5 | Texte - Maîtriser les LLMs et les APIs OpenAI | [README complet](Texte/README.md) | ~10h | Arc agentique 13-20 + Open WebUI live |
| 6 | SemanticKernel - Orchestration agentique avec Microsoft | [README complet](SemanticKernel/README.md) | ~20h | SDK Python + .NET, MCP, multi-modalité |
| 7 | FineTuning - Adapter un modèle à votre tâche | [README complet](FineTuning/README.md) | (durée libre) | LoRA → QLoRA → SFT → DPO → fusion MoE |
...
Les **prochaines étapes** recommandées après ce parcours : explorer les **épics transverses** #3801 (registre SOTA par famille, GenAI en tête) et #1385 (stack GenAI self-hosting complète ComfyUI/Qwen/Forge/vLLM), ou approfondir une sous-série en particulier via son README feuille. Le [hub central](../../README.md) indexe les passerelles vers les autres séries (ML, RL, GameTheory, SymbolicAI) pour des compositions multi-paradigmes.
...
<!-- CATALOG-STATUS
series: GenAI
pedagogical_count: 246
breakdown: Audio=38, Texte=34, Plateformes-Conversationnelles=28, Video=22, Image=21, SemanticKernel=20, PostTraining=19, Integrations-DotNet=15, FineTuning=10, RAG-et-Memoire-Semantique=10, Vibe-Coding=8, 00-GenAI-Environment=6, CaseStudies=5, FallacyDetection=5, Security=5
maturity: BETA=207, ALPHA=21, DRAFT=15, TEMPLATE=3
-->
