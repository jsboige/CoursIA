...
├── FT-00d-LoRA-QLoRA-SOTA-Comparison.ipynb    # Bloc B.5 : QLoRA = peft + bitsandbytes 4-bit NF4 ; mesure structurelle de la fraction nn.Linear (le piège que bnb ne mord que sur Linear), cas SmallCNN/BigMLP dégénérés vs DistilBERT favorable
