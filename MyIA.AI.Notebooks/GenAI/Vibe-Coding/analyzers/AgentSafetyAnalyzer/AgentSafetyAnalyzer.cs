...
// for agent-generated C# code (Epic #10473, axe Roslyn, sub-grain #10500e).
//
...
//
// Sub-grain #10500e (this commit) adds AGSEC005 for credential-prefix detection.
// The contract mirrors the OWASP/CWE-798 "Hardcoded Credentials" pattern: a
// string literal that starts with a well-known provider prefix is almost
// certainly a real secret leaked into source. The analyzer flags it with a
// warning that points the developer to `os.getenv(...)` or a secret manager.
//
