...
<p align="center"><img src="assets/readme/img3-workflow2.webp" alt="Comparaison parallèle Qwen / FLUX / SD35 sur le même prompt (ville futuriste cyberpunk nocturne avec voitures volantes et néons rose/violet/cyan) — 3 modèles avec seeds distincts (42 / 43 / 44) ; asset archive = placeholder non-dégénéré avec std(luminance) distincts par panneau (36.35 / 33.51 / 42.99), en attendant la re-exécution ComfyUI complète côté worker GenAI" width="840"/></p>
