...
<p align="center">
  ...
  <em>Sortie du notebook <a href="01-Foundation/01-1-OpenAI-DALL-E-3.ipynb">01-1</a> : paysage urbain futuriste cyberpunk au coucher de soleil, généré par gpt-image-1 (DALL-E 3 retiré). Le notebook source appelle désormais <code>gpt-image-1</code> depuis la migration PR #4230.</em>
</p>
...
| Notebook | Contenu | Service |
|----------|---------|---------|
| [01-5b-Qwen-Image-Edit-2509](01-Foundation/01-5b-Qwen-Image-Edit-2509.ipynb) | Édition avancée Qwen | ComfyUI |
...
<p align="center">
  <a href="02-Advanced/02-4-Z-Image-Lumina2.ipynb"><img src="assets/readme/lumina2-zimage.webp" width="320" alt="Samouraï robot dans une ville cyberpunk japonaise sous la pluie (armure mécanique à casque cornu, néons roses et magenta, enseignes verticales en kanji, reflets sur sol mouillé) — génération Z-Image Lumina2."></a><br>
  <em>Sortie du notebook <a href="02-Advanced/02-4-Z-Image-Lumina2.ipynb">02-4</a> : samouraï robot cyberpunk généré par Z-Image Lumina2 (Lumina Diffusers) — rendu authentique illustrant le prototypage rapide.</em>
</p>
