...
| **P4** | Intégration au catalogue + fil rouge transverse (README parent, diagramme de mission) | ✔ partiel (fil rouge + README parent + bandeau README rafraîchis + `WHATS-NEW-v0.11.md` atterri via #12307 ; reste le diagramme de mission, tracké #4433) |
