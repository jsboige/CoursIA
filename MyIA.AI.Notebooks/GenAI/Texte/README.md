...
| 10 | `10_LocalLlama.ipynb` | Serveur OpenAI-compatible auto-hébergé (vLLM) : 3 étages honnêtement nommés (local étudiant / auto-hébergé de flotte / repli distant OpenRouter), multi-endpoints, benchmarking | 60 min |
