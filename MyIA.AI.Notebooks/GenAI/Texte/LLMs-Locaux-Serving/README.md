...
| Brique | Rôle | Lien |
|--------|------|------|
| Notebooks Texte (LocalLlama, Quantization, Production Patterns) | *Démontrent* l'usage d'un LLM local | [9](../09_Production_Patterns.ipynb) · [10](../10_LocalLlama.ipynb) · [11](../11_Quantization.ipynb) |
