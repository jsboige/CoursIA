...
| PT-09 | `PT_09_rloo_from_scratch_toy_env.ipynb` | RLOO (REINFORCE Leave-One-Out) — l'autre baseline sans critic, compromis biais-variance vs GRPO | torch from-scratch (no trl) | MLP jouet (CPU, ~1.5k params) | See #1454 |
