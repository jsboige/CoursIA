...
| 03 | Plus de temps, plus de problèmes *(à venir)* | Licence | 03b — Hartmanis–Stearns (aujourd'hui 03) |
...
classe de complexité temporelle : encart §6 du notebook 03 ; `Mathlib.Combinatorics.Matroid`
