...
**Motivation.** Les systèmes de preuve géométriques automatisés connaissent un regain avec l'arrivée des LLM géométriques (AlphaGeometry et consœurs) : l'étude *Wu's Method can Boost Symbolic AI to Rival Silver Medalists and AlphaGeometry to Outperform Gold Medalists at IMO Geometry* (Sinha et al., 2024, arXiv:2404.06405) montre qu'une méthode symbolique *classique* — la méthode de Wen-tsün Wu (1977), fondée sur les ensembles caractéristiques de Ritt — résout 15/30 problèmes de la passerelle IMO-AG-30, dont deux que seuls les moteurs symboliques résolvent. Comprendre Wu, c'est comprendre où le symbolique reste indispensable face au neuronal.
...
- Sinha et al., *Wu's Method can Boost Symbolic AI to Rival Silver Medalists and AlphaGeometry to Outperform Gold Medalists at IMO Geometry* (2024), arXiv:2404.06405 — PDF archivé dans le gisement commun `G:\Mon Drive\MyIA\IA\Bibliographie IA\Symbolic\`.
