...
The lake also carries the theorems **`seven_pid`** and **`eleven_pid`**: the
rings of integers `𝓞 ℚ(ζ₇) = ℤ[ζ₇]` and `𝓞 ℚ(ζ₁₁) = ℤ[ζ₁₁]` of the 7th and
11th cyclotomic fields are principal ideal rings — the first steps beyond
...
#16557, `eleven_pid`: installment 2 (`thirteen_pid` in the next installment).
...
autonomous and does not depend on it. Next installment of #16557:
`thirteen_pid`.
