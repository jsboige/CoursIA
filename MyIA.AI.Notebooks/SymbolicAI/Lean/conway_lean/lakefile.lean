...
-- Pin explicite v4.33.0 (harmonisation #4362, migration #16341) : sans `@`,
-- lake resout la require sur `master` par defaut alors que lake-manifest.json
-- est epingle sur v4.33.0 -> warning `manifest out of date: git revision of
