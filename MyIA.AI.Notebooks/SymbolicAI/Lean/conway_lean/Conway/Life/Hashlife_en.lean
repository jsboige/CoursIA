...
/-
  English mirror of `Hashlife.lean` (FR canonical). Convention EPIC #4980
  (decision ratified 2026-07-04, cf `code-style.md` section Lean i18n): distinct FR + EN sibling
