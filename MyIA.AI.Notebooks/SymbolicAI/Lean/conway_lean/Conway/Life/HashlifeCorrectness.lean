...
(L4971-4995) + miroir NE (L4470-4499, inline sorry accepté via OW #6875) :
...
le sorry résiduel dans `p4_se_overlap_wall` (L4971) **identique** au pattern
NE inline sorry (L4499) — la fidélité est testée à la compilation par
`p4_se_g3_bridge` qui consomme la wall via `exact` (L5066). Pas une
...
prioritaire pour SW (`p4_sw_overlap_wall` L4748) et `case mpr` (L5645) qui
