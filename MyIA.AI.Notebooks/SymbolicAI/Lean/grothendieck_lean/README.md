...
3. **Dette de raccord résolue** : `#11286` — import umbrella de `ExceptionalDirect` **CLOSED 2026-08-16** (PR #11294) : un module orphelin depuis #10357, relié en 6 semaines. L'umbrella importe chaque leaf FR (78) et jamais un `_en` (#16154), tandis que le `globs` du lakefile assure aussi la compilation des 78 siblings `_en`.
