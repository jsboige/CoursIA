...
| 22 | [Lean-22-Galois-Probleme-Inverse-M23](Lean-22-Galois-Probleme-Inverse-M23.ipynb) | Le problème inverse de Galois refermé (arXiv:2608.08538, 9 août 2026) : M₂₃ prouvé simple d'ordre 10 200 960 **à l'écran** (`card_M23`/`simple_M23` exécutés, `#print axioms` = liste blanche), design de Witt S(4,7,23) vérifié des deux côtés (253 heptades), polynôme f₁ de degré 23 manipulé pour de vrai (empreinte, irréductibilité, discriminant 383 chiffres, Frobenius mod p) — les deux énoncés distingués : prouvé vs cité | 45 min |
...
| 29 | [Lean-29-Hecke-Operators-Native](Lean-29-Hecke-Operators-Native.ipynb) | Les opérateurs de Hecke $T_p$ et $U_p$ — compagnon natif du lake `hecke_lean`, premier lake sur la toolchain 4.33.0 (port pédagogique ancré FLT, #14784) : définitions importées et interrogées par `#check`/`#print axioms` en kernel natif `lean4-wsl` | 40 min |
| 30 | [Lean-30-FormalGroups-Native](Lean-30-FormalGroups-Native.ipynb) | Groupes formels multivariés — compagnon natif du lake `formal_groups_lean`, deuxième lake toolchain 4.33.0 (même ancrage FLT et pin Mathlib que `hecke_lean`, #14785) | 40 min |
...
| 27 | EdgeColoring-Tutte-Companion | ~10 | 0 | 0 | **NOUVEAU** (kernel `lean4-wsl`, compagnon App-22 #13031) |
| 28 | Complex-Structure-S6 | ~28 | 6 | - | **NOUVEAU** (kernel python3, reproduction réelle du dépôt piné) |
| 29 | Hecke-Operators-Native | ~32 | 9 | 0 | **NOUVEAU** (kernel `lean4-wsl`, premier lake toolchain 4.33.0, #14784) |
| 30 | FormalGroups-Native | ~33 | 3 | 0 | **NOUVEAU** (kernel `lean4-wsl`, deuxième lake 4.33.0, #14785) |
