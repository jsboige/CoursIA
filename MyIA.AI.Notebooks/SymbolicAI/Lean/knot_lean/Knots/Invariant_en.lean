...
theorem tricolorable_invariant_fails_under_pr1_model :
    ∃ (d₁ d₂ : KnotDiagram),
      ...
      IsTricolorable d₂ := by
  -- Witness pair.
  refine' ⟨{ crossings := [⟨1, 2, 1, 2⟩], numEdges := 2, hwell := by decide },
           { crossings := [⟨1, 2, 1, 2⟩, ⟨3, 4, 3, 4⟩], numEdges := 4, hwell := by decide },
           ?_, ?_, ?_⟩
  ...
  · show ¬ IsTricolorable { crossings := [⟨1, 2, 1, 2⟩], numEdges := 2, hwell := by decide }
  ...
  · show IsTricolorable { crossings := [⟨1, 2, 1, 2⟩, ⟨3, 4, 3, 4⟩], numEdges := 4, hwell := by decide }
...
theorem pr1_counterexample_excluded_under_rho_determined :
    ¬ Reidemeister1'
        { crossings := [⟨1, 2, 1, 2⟩], numEdges := 2, hwell := by decide }
        { crossings := [⟨1, 2, 1, 2⟩, ⟨3, 4, 3, 4⟩], numEdges := 4, hwell := by decide } := by
...
def witnessD1Connected : KnotDiagram :=
  { crossings := [⟨1,2,3,4⟩, ⟨1,2,3,4⟩], numEdges := 4, hwell := by decide }

/-- The witness `d₂` of `reidemeister1Connected_satisfiable` (Reidemeister.lean). -/
def witnessD2Connected : KnotDiagram :=
  { crossings := [⟨1,2,3,4⟩, ⟨5,2,3,4⟩, ⟨1,5,6,6⟩], numEdges := 6, hwell := by decide }
