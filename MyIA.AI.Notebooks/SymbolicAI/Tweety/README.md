...
- [ICT-05-CausalEmergence](../../IIT/ICT-Series/ICT-05-CausalEmergence.ipynb) — le même `do` monte d'un cran : à **quelle échelle** un système fait-il le plus de travail causal ?
