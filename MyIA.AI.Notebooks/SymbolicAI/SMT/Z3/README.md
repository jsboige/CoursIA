...
Le binding Z3.Linq traduit des requêtes LINQ C# en formules SMT — on décrit les contraintes, le solveur produit la solution. Série .NET 9 de **12 notebooks** (~8h15), du théorème linéaire à la coloration de graphe sur le graphe de Petersen (nombre chromatique `χ` par recherche SAT).
...
12. **Notebook 09** clôt sur une **structure irrégulière** : la coloration de graphe sur le graphe de Petersen (10 sommets, 15 arêtes). Le nombre chromatique `χ = 3` est trouvé par recherche linéaire SAT (UNSAT à 2 couleurs, SAT à 3), confronté à une heuristique first-fit order-sensible qui gaspille une couleur selon l'ordre de parcours. Petersen, célèbre contre-exemple de la théorie des graphes, illustre pourquoi un solveur *exhaustif* bat une heuristique *locale* sur les structures pièges
