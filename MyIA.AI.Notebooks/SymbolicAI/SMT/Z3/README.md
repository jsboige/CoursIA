...
- **Série sœur Z3-Python** : [Z3-Python](../Z3-Python/README.md) expose l'API Z3 *complète* (tactiques, `BitVec`, théorie des chaînes `Re`/`InRe`, quantificateurs, preuves) que le binding LINQ masque volontairement. C'est le prolongement naturel quand on veut pousser la modélisation au-delà des entiers et tableaux, notamment pour la **théorie native des chaînes** (génération de témoin depuis un regex, notebook Z3-Python-04).
