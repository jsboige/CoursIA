...
Le binding Z3.Linq traduit des requêtes LINQ C# en formules SMT — on décrit les contraintes, le solveur produit la solution. Série .NET 9 de **13 notebooks** (~8h50), du théorème linéaire aux cryptarithmes positionnels (arithmétique positionnelle + contrainte globale `Distinct` sur le classique SEND + MORE = MONEY).
