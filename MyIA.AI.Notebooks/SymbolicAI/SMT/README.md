...
[← Intelligence Symbolique](../README.md) | [Z3-Linq2Z3 (C# .NET) →](Z3-Linq2Z3/README.md) | [Z3-API →](Z3-API/README.md)
...
| [**Z3-API/**](Z3-API/README.md) | Python / **z3-py** + **Microsoft.Z3** | API directe : pyz3 (Python) + 6 twins C# Microsoft.Z3 — accès à l'API intégrale du solveur | 24 (Python + C# jumeaux) | PRODUCTION |
...
- **Exploiter toute la puissance de Z3 en Python (ou en C# via API directe)** : aller vers [Z3-API/](Z3-API/README.md). Idéal pour la recherche, le prototypage rapide et les théories avancées (BitVec, Array, tactiques).
...
- **Z3-API (z3-py + Microsoft.Z3 twins)** : la série [Z3-API/](Z3-API/README.md) (24 notebooks : 13 Python + 6 C# jumeaux + 5 outputs gitignored) ouvre l'API complète — tactiques, `BitVec`/`Array`/`String`, quantificateurs, preuve par réfutation, optimisation Pareto/MaxSAT, en Python direct ou en C# via Microsoft.Z3.
