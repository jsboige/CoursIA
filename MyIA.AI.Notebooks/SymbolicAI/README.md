...
<!-- CATALOG-STATUS
series: SymbolicAI
pedagogical_count: 261
breakdown: Lean=50, SMT=46, Tweety=34, SmartContracts=30, Argument_Analysis=28, SemanticWeb=26, Planners=25, SymbolicLearning=21, root=1
maturity: BETA=251, ALPHA=6, DRAFT=4
-->
...
| 18 | [Lean-18-Search-AStar-Optimality](../Search/Part1-Foundations/Lean-18-Search-AStar-Optimality.ipynb) | Lean 4 / WSL | Preuve d'optimalité A* dans le lake `planners_lean` : consistance, admissibilité, branchement | 3 |
