...
breakdown: Lean=49, SMT=46, Tweety=33, SmartContracts=30, Argument_Analysis=28, SemanticWeb=26, Planners=25, SymbolicLearning=21, root=1
maturity: BETA=249, ALPHA=6, DRAFT=4
-->
...
| 18 | [Search-03e-AStar-Optimality](../Search/Part1-Foundations/Search-03e-AStar-Optimality.ipynb) | Lean 4 / WSL | Preuve d'optimalité A* dans le lake `planners_lean` : consistance, admissibilité, branchement | 3 |
