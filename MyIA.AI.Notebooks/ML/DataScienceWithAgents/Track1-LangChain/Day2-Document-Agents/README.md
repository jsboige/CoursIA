...
[← Track1-LangChain (track)](../README.md) | [Journée 1 →](../Day1-Foundations/Labs/README.md) | [Journée 3 →](../Day3-Data-Agents/README.md)
...
- Avoir suivi la [Journée 1](../Day1-Foundations/Labs/README.md) (Pandas, Matplotlib, régression linéaire).
- **LangChain** + clé API OpenAI (les labs 2 et 3 appellent un LLM).

## Suite

La [Journée 3](../Day3-Data-Agents/README.md) monte en abstraction : data wrangling agentique, visualisation/ML, puis le premier agent d'analyse de données autonome (Lab 7).
