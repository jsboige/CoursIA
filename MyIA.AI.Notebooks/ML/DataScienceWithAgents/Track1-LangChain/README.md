...
Une fois le track mono-agent LangChain maîtrisé, la formation monte en puissance vers les **systèmes multi-agents** : [`Track2-GoogleADK`](../Track2-GoogleADK/README.md) (Google ADK, boucles planner-coder, DS-STAR / MLE-STAR, compétitions Kaggle).
