...
Le workshop se poursuit avec le track **Google ADK** dans [`Track2-GoogleADK`](../../Track2-GoogleADK/README.md) : fondations ADK (Lab 8), agents DS-STAR / MLE-STAR, puis mise en production.
