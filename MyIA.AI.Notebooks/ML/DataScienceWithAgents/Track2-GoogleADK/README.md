# Track2-GoogleADK - Agents IA pour Data Science avec Google ADK
...
```bash
# Depuis le dossier Track2-GoogleADK/
...
Causes courantes : mauvais chemin `.env` (doit être dans `Track2-GoogleADK/`), clé API invalide, ou URL base incorrecte pour vLLM.
