...
| [2.8c-Borne-Temoin-Concentration](2.8c-Borne-Temoin-Concentration.ipynb) | *Carte transversale* — mise en regard du triptyque BORNE / TÉMOIN EXTRÉMAL / CONCENTRATION dans [`learning_theory_lean/`](../../learning_theory_lean/README.md) | **Voir la carte** : qui porte quoi ? Sections 1--3 absorbées par 2.8b (Hoeffding) et 2.8d (Novikoff + témoin) — ce notebook reste la **table de lecture transversale** | arithmétique exacte |
