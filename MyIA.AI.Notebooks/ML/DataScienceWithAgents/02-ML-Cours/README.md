...
| [2.5c-Equite-Sous-Groupes](2.5c-Equite-Sous-Groupes.ipynb) | Équité par sous-groupe : parité démographique, equalized odds, l'incompatibilité des trois métriques sous prévalences différentes (Chouldechova) et le post-traitement par seuils par groupe (Hardt) | **L'accuracy globale ne suffit pas** : 97,2 % global coexiste avec deux groupes à [0,977–0,995] et [0,945–0,970] | synthétique contrôlé (2 groupes, prévalences réglables) |
...
flowchart TD
    ...
    M["2.11 - Régularisation sparse (LASSO)<br/>géométrie L1 vs L2<br/>coord descent, sélection de λ, paires corrélées"]
    C -. "régulariser en grande dimension : L1 vs L2" .-> M
    K -. "LassoCV y apparaît comme hyperparamètre" .-> M
```
