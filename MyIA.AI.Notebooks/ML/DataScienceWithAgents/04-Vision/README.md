...
| [4.2d — Détection anchor-free : le renversement CenterNet](4.2d-Detection-AnchorFree-From-Scratch.ipynb) | CenterNet-like à la main sur le terrain du 4.2c : cible gaussienne (rayon dérivé d'un IoU 0,7), offset sous-cellulaire, régression de taille, focal loss modifiée (facteurs (1−p)², p², (1−y)⁴) avec garde-fous analytiques, décodage par max-pool 3×3 + top-K, NMS, mAP VOC07/VOC10 au même harnais que 4.2c, ablation de l'offset, mesure des collisions de centres, 3 exercices | **Prédire un point, pas une boîte** : l'anchor-free supprime la grille et ses cinq hyperparamètres — la contrepartie mesurée est la quantification (l'offset vaut plus de 10 points de mAP07) et une capacité mono-échelle qui rend 6 à 12 points aux anchors sur ce terrain de tailles étalées | 83 621 paramètres, capacité calée sur les 74 717 du 4.2c (32 canaux : même verdict, l'écart ne vient pas de la taille) ; 12 époques en 17 s GPU ; focal loss vérifiée au garde-fou (faux positif confiant sur un voisin à y = 0,6 puni à 2,56 % du fond pur, théorie (1−0,6)⁴) ; mAP@0.5 (mêmes 400 images / 817 GT) : VOC07 0,790 / VOC10 0,796 contre 0,853 / 0,914 aux anchors ; ablation sans offset : 0,685 / 0,726 ; collisions de centres : 0 sur 817 GT, contrôle positif forcé détecté (See #16057) |
