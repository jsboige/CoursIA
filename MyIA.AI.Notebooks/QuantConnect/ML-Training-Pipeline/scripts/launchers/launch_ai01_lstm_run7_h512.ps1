# launch_ai01_lstm_run7_h512.ps1
...
#
# Usage:
#   .\launch_ai01_lstm_run7_h512.ps1            # Full training
#   .\launch_ai01_lstm_run7_h512.ps1 -DryRun    # Quick validation
...
$OutDir     = Join-Path $RootDir "outputs\ai01_lstm_run7_h512_$Ts"
