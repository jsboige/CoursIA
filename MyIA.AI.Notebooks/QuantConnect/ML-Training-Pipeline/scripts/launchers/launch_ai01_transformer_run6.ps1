...
#
# Usage:
#   .\launch_ai01_transformer_run6.ps1            # Full training
#   .\launch_ai01_transformer_run6.ps1 -DryRun    # Quick validation
...
$TrainScript= Join-Path $ScriptsDir "train_transformer.py"
...
$OutDir     = Join-Path $RootDir "outputs\ai01_transformer_run6_$Ts"
$CkptDir    = Join-Path $RootDir "checkpoints\transformer"
...
Write-Host "[LAUNCH] Starting Transformer training..."
Write-Host "[LAUNCH] D=$DModel Heads=$NHead Layers=$NumLayers FF=$DimFF Epochs=$Epochs Batch=$BatchSize Advanced=19"
