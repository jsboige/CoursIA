...
| S1 | M15 LSTM h=32 | NO BEATS | -0.020 | 33/84 | §C conjonction ne tient pas (h=1 dm_p=0.0014, h=5 dm_p=0.0216, h=10 dm_p=0.1367) ; BEATS initial etait sur `p_sign` seul, pas DM. median_mse_change_pct=+17.5% (LSTM moins precis en mediane). Retiré du catalogue de keepers. |
