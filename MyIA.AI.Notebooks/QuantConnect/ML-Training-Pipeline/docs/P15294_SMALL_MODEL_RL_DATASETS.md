...
| 5 | Hermes function-calling v1 | Function-calling single/multi-tour + JSON mode | Oui : structure JSON (schéma) | Alternative à #1 si licence/format mieux adapté au harnais | À épingler au moment du run (source non confirmée dans cette veille bornée) |
