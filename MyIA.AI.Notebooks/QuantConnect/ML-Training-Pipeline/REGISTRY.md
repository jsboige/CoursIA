...
- **Artefacts** : `scripts/results/m12_har_rv_j/results.json` (97 061 octets — biais signés, p-values DM, preuves de folds 5/5/5 sur les trois côtés HAR/HAR-calibré/HRJ, manifeste données par actif) et `m12_har_rv_j_results.csv` (43 026 octets). Sweep réel 21/21, 0 échec, 220 s. Fiche technique : `docs/M12_HAR_RV_J.md` (historique Cycle 31 préservé) ; notebook réexécuté : `m12_har_rv_j_research.ipynb`.
