...
class custom_alpha(AlphaModel):
    ...
    def __init__(self, algo):
        ...
        # v3b: removed spy_sma200 reference (SMA200 filter degraded results)
    ...
    def Update(self, algo, data):
        ...
        for symbol in self.activeStocks:
            ...
            # buy signal
            # v3b: removed SMA200 regime filter (degraded results). EMA50/200 per-stock filter sufficient.
            if ema_trend >= 210:
