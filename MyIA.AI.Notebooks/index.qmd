...
**Vous débutez ?** Suivez l'un des [trois parcours d'apprentissage](../parcours.qmd) — chaque série ci-dessous indique son parcours et son niveau.
...
::: {.series-card}
### [FallacyDetection](FallacyDetection/README.md) — Détection de sophismes (Qwen FT + PT)

Classification de sophismes par Qwen 3.5/3.6 : fine-tuning (mémorisation du motif « général → particulier ») vs post-training, interprétabilité par sparse autoencoders (SAE). Série en construction — EPIC #10355, phases survey et datasets livrées.

**Notebooks** : 2 · **Kernels** : python3 · **GPU** : oui
:::
