...
Provenance des images de `assets/readme/` (EPIC #5654, source 1 = extraction d'outputs de notebooks). Les index de cellule sont absolus (toutes cellules : markdown + code), conformément à la convention `extract_readme_figures.py`. Les figures couvrent les strates 1-4 stables (la strate 5 ICT-15..25 est gated — Epic #4588).
