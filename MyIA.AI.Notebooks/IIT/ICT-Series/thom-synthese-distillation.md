...
**Référence :** [ICT-09-AgencyRegeneration-Python](ICT-09-AgencyRegeneration-Python.ipynb) (régénération Gray-Scott comme morphogenèse), [ICT-19b-EnjeuBattery-Raffinement](ICT-19b-EnjeuBattery-Raffinement.ipynb) (`repair_gain` +0.82±0.27 sur S4).
