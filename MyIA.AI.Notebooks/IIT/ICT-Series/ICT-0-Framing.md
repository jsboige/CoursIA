...
| **ICT-12b** | [Valence apprise](ICT-12b-LearnedValence.ipynb) — **strate 3, tresse C1**. La valence cesse d'être câblée dans le champ : elle s'**apprend**, se transfère d'un contexte à l'autre et se réversibilise — prolongement direct du champ de valence d'ICT-12. Voir [#7740](https://github.com/jsboige/CoursIA/issues/7740) | ✅ |
| **ICT-12c** | [Animat prégnance/valence incarné](ICT-12c-PregnanceAnimat.ipynb) — **strate 3, tresse C1**. L'animat porte sa prégnance dans son corps et non dans le champ extérieur : la scène actantielle d'ICT-12 rejouée en incarné. Voir [#7740](https://github.com/jsboige/CoursIA/issues/7740) | ✅ |
| **ICT-12d** | [Animat inhibé (Laborit)](ICT-12d-InhibitedActionAnimat.ipynb) — **strate 3, tresse C2**. L'inhibition de l'action : quand ni la fuite ni la lutte ne sont disponibles, que devient la trajectoire ? Pendant négatif d'ICT-12, repris au niveau collectif par ICT-30. Voir [#7741](https://github.com/jsboige/CoursIA/issues/7741) | ✅ |
...
| **ICT-15b** | [SensitivityCanonicity](ICT-15b-SensitivityCanonicity.ipynb) — **strate 5, 1er lecteur d'obstruction**. La sensibilité (Huang 2019) comme scalaire local : stabilité du verdict de convergence aux perturbations contrôlées du substrat. Voir [#7288](https://github.com/jsboige/CoursIA/issues/7288) | ✅ |
| **ICT-15c** | [Méta-proxy d'obstruction](ICT-15c-MetaProxyObstruction.ipynb) — **strate 5, 2e lecteur, tresse C5**. La structure des *désaccords entre proxys* comme objet expérimental : quand un proxy $\Phi/F/K$ masque une divergence de régime (faux positif de convergence). Voir [#7395](https://github.com/jsboige/CoursIA/issues/7395) · [#7744](https://github.com/jsboige/CoursIA/issues/7744) | ✅ |
| **ICT-15d** | [Cochaîne de Čech pondérée](ICT-15d-CechObstruction.ipynb) — **strate 5, 3e lecteur**. Une obstruction cohomologique intra-substrat qui ne se réduit ni à un proxy $\Phi/F/K$ ni à la sensibilité de Huang — module [`ict/cech_obstruction.py`](ict/cech_obstruction.py). Voir [#7744](https://github.com/jsboige/CoursIA/issues/7744) | ✅ |
| **ICT-15e** | [Pont #2 — recouvrabilité = agentivité](ICT-15e-Bridge2-RecoverabilityAgency.ipynb) — **strate 5**. Cinq bridges falsifiables : la récupération après `do(·)` discrimine l'agentivité (un dissipateur pur ne recouvre pas). Raccorde la strate 5 au critère d'ICT-9/ICT-19. Voir [#8077](https://github.com/jsboige/CoursIA/issues/8077) | ✅ |
| **ICT-15f** | [Pont #1-bis — la famille découplée](ICT-15f-Bridge1bis-DecoupledFamily.ipynb) — **strate 5**. Famille à découplage construit ($\sigma \perp$ largeur de bassin) : c'est la largeur de bassin, non $\sigma$ seul, qui porte le négatif falsifiant ICT-15e. Voir [#9531](https://github.com/jsboige/CoursIA/issues/9531) · [#8077](https://github.com/jsboige/CoursIA/issues/8077) | ✅ |
| **ICT-15g** | [Exploitation empirique de Huang](ICT-15g-EmpiricalHuangExploitation.ipynb) — **strate 5**. Prolongement d'ICT-15b : la sensibilité rejouée sur les 4 substrats réels d'ICT-15c à paramètres identiques, pour la rendre lisible **côte à côte** avec les proxys 15c/15d. Renommé depuis `ICT-15b` (collision de slot). Voir [#7288](https://github.com/jsboige/CoursIA/issues/7288) | ✅ |
...
| **ICT-19b** | [Raffinement de la batterie ENJEU](ICT-19b-EnjeuBattery-Raffinement.ipynb) — **strate 4, GPU-free**. Résout les stubs de la tranche 3 et corrige le faux nul d'ICT-19 : la mesure S4 Gray-Scott passe en espace de champ. Voir [#5728](https://github.com/jsboige/CoursIA/issues/5728) | ✅ |
...
| **ICT-26** | [Convention de signalisation](ICT-26-SignalingConvention.ipynb) — **strate 7, expérience A**. Comment un canal arbitraire devient une convention stable — module [`ict/signaling_convention.py`](ict/signaling_convention.py). Voir [#7746](https://github.com/jsboige/CoursIA/issues/7746) | ✅ |
| **ICT-27** | [Invention de symboles](ICT-27-SymbolInvention.ipynb) — **strate 7, expérience B**. Le passage d'une convention *donnée* (A) à un symbole *inventé* hors du répertoire initial. Voir [#7746](https://github.com/jsboige/CoursIA/issues/7746) | ✅ |
| **ICT-28** | [Adoption collective](ICT-28-CollectiveAdoption.ipynb) — **strate 7, expérience C, tresse C4**. Seuil de performativité : à partir de quelle fraction d'adoptants une innovation devient-elle une norme auto-entretenue ?. Voir [#7743](https://github.com/jsboige/CoursIA/issues/7743) · [#7746](https://github.com/jsboige/CoursIA/issues/7746) | ✅ |
| **ICT-29** | [Inoculation d'un concept](ICT-29-ConceptInoculation.ipynb) — **strate 7, expérience D**. Une fois la convention installée (A), un concept peut-il être introduit puis propagé comme un vaccin cognitif ?. Voir [#7746](https://github.com/jsboige/CoursIA/issues/7746) | ✅ |
| **ICT-30** | [Invention inhibée](ICT-30-InhibitedInvention.ipynb) — **strate 7, expérience E, tresse C2**. L'inhibition de Laborit (cf. ICT-12d) portée au niveau collectif : quand l'opérateur de workspace s'effondre, l'invention collective cesse. Voir [#7741](https://github.com/jsboige/CoursIA/issues/7741) · [#7746](https://github.com/jsboige/CoursIA/issues/7746) | ✅ |
| **ICT-Argumentation** | [Trajectoires de croyance](ICT-Argumentation-BeliefTrajectories.ipynb) — **graine strate 6, spécial non-numéroté**. L'instrumentation $\Phi$-trajectoires d'ICT-1 appliquée à des trajectoires **argumentatives** (Phase B, banc multilingue). Voir [#7289](https://github.com/jsboige/CoursIA/issues/7289) · [#4588](https://github.com/jsboige/CoursIA/issues/4588) | ✅ |
| **ICT-Dissociation** | [Saillance ⊥ prégnance](ICT-Dissociation-SaillancePregnance.ipynb) — **cas de la matrice inversée, hors séquence numérotée**. Le cas $s \perp \pi$ : saillance et prégnance-valence peuvent diverger. Registre : [`docs/ict/dissociations-matrix.md`](../../../docs/ict/dissociations-matrix.md). Voir [#9533](https://github.com/jsboige/CoursIA/issues/9533) | ✅ |
| **ICT-Dissociation** | [Boucle auto-référentielle `p̂`](ICT-Dissociation-PhatSelfReference.ipynb) — **cas de la matrice inversée, hors séquence numérotée**. Le représentant interne `p̂` pris comme son propre objet — second cas du générateur de dissociations. Voir [#9533](https://github.com/jsboige/CoursIA/issues/9533) | ✅ |
