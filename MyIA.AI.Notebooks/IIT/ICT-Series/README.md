...
La strate 3 se poursuit sur la feuille de route de [ICT-0-Framing](ICT-0-Framing.md) : **ICT-13** (morphodynamique stratégique : une stratégie est-elle une forme stable ? — dilemme du prisonnier itéré d'Axelrod, bassins d'invasion) puis **ICT-Synthèse**.
