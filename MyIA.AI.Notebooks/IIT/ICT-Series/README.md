...
<tr>
<td align="center" colspan="3"><b>Capstone cross-substrat — convergence Φ/F/K & réversibilisation (S5)</b><br><a href="ICT-Synthese-CrossSubstrat.ipynb"><img width="290" alt="Gate 4 du capstone ICT-Synthese : convergence Phi/F/K sur quatre substrats (tri auto-organisé, bistable, réplicateur d'Axelrod, activations SAE d'un LLM). Barres groupées par substrat, trois jambes (Phi, F, K). Phi et F covarient et ordonnent les substrats à l'identique (tri > réplicateur > bistable > LLM, tau de Kendall Phi-F = +1.00) ; K ordonne autrement. Le substrat LLM est le plus faible sur les trois jambes." src="assets/readme/ict-synthese-gate4-phifk.png"></a> &nbsp; <a href="ICT-Synthese-CrossSubstrat.ipynb"><img width="290" alt="Gate 5 du capstone ICT-Synthese : jambe temporelle de l'émergence (réversibilisation ICT-18). Par substrat, production d'entropie sigma_real et distance à la chaîne réversibilisée, sur échelle symlog. Le tri est fortement irréversible (sigma élevé) ; le bistable est quasi-nul (réversible) ; l'asymétrie temporelle discrimine les substrats de façon orthogonale aux jambes Phi/F/K." src="assets/readme/ict-synthese-gate5-reversibilisation.png"></a></td>
</tr>
</table>
