...
| [ICT-15b-SensitivityCanonicity](ICT-15b-SensitivityCanonicity.ipynb) | **Sensibilité — canonicité du banc Φ/F/K** — raffinement d'ICT-15 sur la stabilité du verdict de convergence aux perturbations contrôlées du substrat (bruit d'implémentation, recalibrage des coarse-grainings), protocole de re-mesure multi-graines sur le banc cross-substrat | [#5090](https://github.com/jsboige/CoursIA/issues/5090) (sub-issue raffinement) |
| [ICT-15c-MetaProxyObstruction](ICT-15c-MetaProxyObstruction.ipynb) | **Méta-proxy obstruction** — exploration des obstructions possibles au verdict d'ICT-15 : quand un proxy Φ/F/K cache une divergence de régime (faux-positif de convergence) ; banc adversarial sur substrats où le triplet co-varie par construction | [#5090](https://github.com/jsboige/CoursIA/issues/5090) (sub-issue obstruction) |
