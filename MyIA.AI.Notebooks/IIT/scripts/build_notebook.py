...
cells.append({
    ...
    "source": [
        ...
        "## Navigation\n",
        "\n",
        "Ce notebook est le **deuxieme volet** de la serie IIT. Il approfondit les concepts introduits dans [Intro_to_PyPhi](Intro_to_PyPhi.ipynb).\n",
        "\n",
        "| Notebook | Contenu | Duree |\n",
        "|----------|---------|-------|\n",
        "| [1. Intro_to_PyPhi](Intro_to_PyPhi.ipynb) | Reseaux, Phi, CES, macro-subsystemes | 60-90 min |\n",
        "| **2. AdvancedTopics** (ce notebook) | Partitions MIP, repertoires, MICE, reseaux elargis | 60-90 min |\n",
        "\n",
        "**Prerequis** : avoir complete le notebook 1 (Intro_to_PyPhi).\n",
        "\n",
        "---\n",
        "\n",
        "## Plan de ce notebook\n",
