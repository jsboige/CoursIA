...
| **Bayésien MCMC** (PyMC) | [PyMC-5](../Probas/PyMC/PyMC-5-Causal-Inference.ipynb) | opérateur natif `pm.do(model, {X:x})` ; backdoor / front-door | contrefactuel par abduction (postérieur sur les exogènes) |
...
message passing, [PyMC-5](../Probas/PyMC/PyMC-5-Causal-Inference.ipynb) MCMC) pour *calculer* les effets
...
breakdown: ICT-Series=34, root=3
maturity: BETA=23, PRODUCTION=11, ALPHA=3
-->