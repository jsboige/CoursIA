...
breakdown: ICT-Series=23, root=3
maturity: BETA=16, PRODUCTION=9, ALPHA=1
-->
...
│   ├── ICT-*.ipynb             # Notebooks numérotés 1..21 et 23 + raffinement ICT-19 + ICT-Synthese (5 strates, Epic #4588 — cf son README)
