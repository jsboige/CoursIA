...
series: ALL
total: 1306
breakdown: SymbolicAI=304, GenAI=246, Search=155, ML=119, QuantConnect=115, GameTheory=109, IIT=90, Probas=74, Sudoku=38, RL=36, Complexity=8, CaseStudies=6, NLP=5, cross-series=1
maturity: BETA=1154, DRAFT=84, ALPHA=64, TEMPLATE=4
-->
...
IIT
├── ICT-Series/ - Integrated Causal Trajectories (5 substrats : tri, Gray-Scott, Axelrod, transformer+SAE, Jeu de la Vie certifié Lean)
