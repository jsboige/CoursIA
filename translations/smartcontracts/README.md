...
|---------|-------|-----------|----------|
| [`smartcontracts.csv`](smartcontracts.csv) | `SymbolicAI/SmartContracts/` | 27 (SC-00-Cypherpunk-Origins-Python → SC-26-Final-Project-Python, parité Solidity/Foundry/Vyper/Solana/Move + Python tutorials) | 956 (header + 21 990 lignes CSV-escaped, 20 colonnes) |
