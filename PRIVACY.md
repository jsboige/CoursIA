...
Cette frontière est soutenue automatiquement : des contrôles CI refusent les sorties de
notebooks susceptibles d'introduire des données privées (`pii_no_output`) et le dépôt est
audité pour les secrets en clair (`gitleaks`). L'historique public reste consultable.
