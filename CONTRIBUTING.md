...
Les étapes ci-dessous guident la préparation d'une Pull Request. Si votre contribution est utile mais incomplète, ouvrez-la et décrivez ce que vous avez pu vérifier : les agents vous aideront à la qualifier.
...
3. **Créez une Pull Request** vers le dépôt principal
   ...
   - Pour une correction d'exercice, précisez le notebook, l'exercice et le crédit souhaité
