...
NOTEBOOK_SUBTREES = (
    ...
    "MyIA.AI.Notebooks/GenAI/Image/",         # tranche 11 #10923 (20)
    "MyIA.AI.Notebooks/GenAI/Audio/",        # tranche 11 #10923 (30)
    "MyIA.AI.Notebooks/GenAI/Video/",        # tranche 11 #10923 (21)
    "MyIA.AI.Notebooks/GenAI/Texte/",        # tranche 11 #10923 (21)
    "MyIA.AI.Notebooks/GenAI/SemanticKernel/",  # tranche 11 #10923 (25)
    "MyIA.AI.Notebooks/GenAI/Aspire/",        # tranche 12 #10923 (2)
    "MyIA.AI.Notebooks/GenAI/RAG-et-Memoire-Semantique/",  # tranche 12 #10923 (1)
    "MyIA.AI.Notebooks/GenAI/CaseStudies/",   # tranche 12 #10923 (4)
    "MyIA.AI.Notebooks/CaseStudies/",         # tranche 12 #10923 (6)
)
