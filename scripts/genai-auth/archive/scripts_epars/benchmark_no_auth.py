#!/usr/bin/env python3
"""
Script de benchmark pour ComfyUI Qwen - Version sans authentification
...
class ComfyUIBenchmarkNoAuth:
    ...
    def save_results(self, output_file=None):
        ...
        if output_file is None:
            ...
            output_file = f"benchmark_results_no_auth_{timestamp}.json"
...
def main():
    parser = argparse.ArgumentParser(description='Benchmark ComfyUI Qwen (No Auth)')
    ...
    benchmark = ComfyUIBenchmarkNoAuth(args.server, args.workflow)
