...
class QwenSetup:
    ...
    def test_image_generation(self) -> bool:
        ...
        # Utilisation de consolidated_tests.py car test_generation_image_fp8_officiel.py est manquant
        script_path = Path("scripts/genai-auth/utils/consolidated_tests.py")
