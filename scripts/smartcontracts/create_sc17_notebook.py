...
"\n"
"### Duree estimee : 70 minutes", "header"))
...
# === SECTION 2: PARTIE 1 - CONSTRUCTION A LA MAIN ===
cells.append(md(
"---\n"
"\n"
...
"- Candidat C : `[0, 0, 1]`\n"
"\n"
"Chaque composante est chiffree individuellement.", "paillier-intro"))
...
"encrypt-interpretation"))

# === SECTION 3: DECOMPTE HOMOMORPHIQUE ===
cells.append(md(
"---\n"
"\n"
...
"sans les dechiffrer. Seul le **total** est ensuite dechiffre.", "tally-intro"))
...
"C'est la que les ZKP interviennent.", "tally-interpretation"))

# === SECTION 4: ZKP VALIDITE ===
cells.append(md(
"---\n"
"\n"
...
'    print()\n'
'    print("Note : ElectionGuard necessite Python 3.9+ et GMP (GNU Multiple Precision)")\n'
'    print("Sur Windows : pip install gmpy2 electionguard")\n'
'    print()\n'
'    print("La section suivante montre le code ElectionGuard a titre d\'illustration.")\n'
'    print("Les concepts fondamentaux ont deja ete demontres dans les sections precedentes.")\n'
