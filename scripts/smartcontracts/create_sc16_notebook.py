...
"pertinent pour le vote electronique (section 6).", "concepts-interpretation"))
...
"\n"
"La bibliotheque `phe` (python-paillier) implemente tout cela.", "paillier-intro"))
...
"paillier-interpretation"))

# === SECTION 3: CKKS / TENSEAL ===
cells.append(md(
"---\n"
"\n"
...
"4. La precision est configurable (~40 bits pour des calculs ML classiques)", "ckks-intro"))
...
"- Performance ~10 000x plus lente que le calcul en clair", "concrete-intro"))
...
"3. Reconstruction : interpolation de Lagrange avec $k$ parts quelconques", "mpc-intro"))
...
"- **Hybride** : combiner les deux pour le meilleur des deux mondes", "mpc-vs-he"))
...
"\n"
"### Squelette a completer", "exercise-intro"))
