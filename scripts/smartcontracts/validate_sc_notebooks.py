...
NOTEBOOKS = [
    ...
    ("00-Foundations", "SC-00-Cypherpunk-Origins-Python", "standalone"),
    ("00-Foundations", "SC-01-Setup-Foundry-Python", "foundry"),
    ("00-Foundations", "SC-02-Setup-Web3py-Python", "anvil"),
    ("01-Solidity-Foundation", "SC-03-Solidity-Basics-Python", "anvil"),
    ("01-Solidity-Foundation", "SC-04-Functions-State-Python", "anvil"),
    ("01-Solidity-Foundation", "SC-05-Inheritance-Python", "anvil"),
    ("01-Solidity-Foundation", "SC-06-Errors-Events-Python", "anvil"),
    ("02-Solidity-Advanced", "SC-07-Token-Standards-Python", "anvil"),
    ("02-Solidity-Advanced", "SC-08-DeFi-Primitives-Python", "anvil"),
    ("02-Solidity-Advanced", "SC-09-DAO-Governance-Python", "anvil"),
    ("02-Solidity-Advanced", "SC-10-Account-Abstraction-Python", "anvil"),
    ("02-Solidity-Advanced", "SC-11-LLM-Assisted-Python", "llm"),
    ("03-Foundry-Testing", "SC-12-Foundry-Testing-Python", "foundry"),
    ("03-Foundry-Testing", "SC-13-Fuzz-Invariants-Python", "foundry"),
    ("03-Foundry-Testing", "SC-14-Formal-Verification-Python", "foundry"),
    ("04-Privacy-Cryptography", "SC-15-Zero-Knowledge-Proofs-Python", "crypto"),
    ("04-Privacy-Cryptography", "SC-16-Homomorphic-Encryption-Python", "crypto"),
    ("04-Privacy-Cryptography", "SC-17-E2E-Verifiable-Voting-Python", "crypto"),
    ("05-Alternative-Chains", "SC-18-Vyper-Python", "anvil"),
    ("05-Alternative-Chains", "SC-19-Ripple-XRP-Python", "network"),
    ("05-Alternative-Chains", "SC-20-Bitcoin-Scripting-Python", "standalone"),
    ("05-Alternative-Chains", "SC-21-Move-Sui-Python", "theoretical"),
    ("05-Alternative-Chains", "SC-22-Solana-Anchor-Python", "theoretical"),
    ("06-Real-World", "SC-23-Cross-Chain-Python", "theoretical"),
    ("06-Real-World", "SC-24-Testnet-Deploy-Python", "network"),
    ("06-Real-World", "SC-25-Mainnet-Deploy-Python", "network"),
    ("06-Real-World", "SC-26-Final-Project-Python", "anvil"),
]
...
NOTEBOOK_IMPORTS = {
    "SC-00-Cypherpunk-Origins-Python": ["hashlib", "Crypto"],
    "SC-02-Setup-Web3py-Python": ["web3", "solcx"],
    "SC-03-Solidity-Basics-Python": ["web3", "solcx"],
    "SC-04-Functions-State-Python": ["web3", "solcx"],
    "SC-05-Inheritance-Python": ["web3", "solcx"],
    "SC-06-Errors-Events-Python": ["web3", "solcx"],
    "SC-07-Token-Standards-Python": ["web3", "solcx"],
    "SC-08-DeFi-Primitives-Python": ["web3", "solcx"],
    "SC-09-DAO-Governance-Python": ["web3", "solcx"],
    "SC-10-Account-Abstraction-Python": ["web3", "solcx"],
    "SC-11-LLM-Assisted-Python": ["openai", "anthropic", "requests"],
    "SC-15-Zero-Knowledge-Proofs-Python": ["Crypto", "py_ecc"],
    "SC-16-Homomorphic-Encryption-Python": ["phe"],
    "SC-17-E2E-Verifiable-Voting-Python": ["phe", "Crypto"],
    "SC-18-Vyper-Python": ["vyper", "web3"],
    "SC-19-Ripple-XRP-Python": ["xrpl"],
    "SC-20-Bitcoin-Scripting-Python": ["bitcoin"],
    "SC-24-Testnet-Deploy-Python": ["web3"],
    "SC-25-Mainnet-Deploy-Python": ["web3"],
    "SC-26-Final-Project-Python": ["web3", "solcx", "phe"],
}
