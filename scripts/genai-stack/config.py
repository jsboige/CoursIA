...
SERVICES: Dict[str, Dict[str, Any]] = {
    ...
    # --- Audio APIs (OpenAI-compatible) ---
    "whisper-api": {
        "compose_dir": SERVICES_DIR / "whisper-api",
        ...
        "gpu_id": 0,
        "vram_required": "4GB+",
        "remote_url": "https://whisper-api.myia.io",
    },
    "tts-api": {
        "compose_dir": SERVICES_DIR / "tts-api",
        ...
        "gpu_id": 1,
        "vram_required": "2GB+",
        "remote_url": "https://tts-api.myia.io",
    },
    "musicgen-api": {
        "compose_dir": SERVICES_DIR / "musicgen-api",
        ...
        "gpu_id": 1,
        "vram_required": "6GB+",
        "remote_url": "https://musicgen-api.myia.io",
    },
    "demucs-api": {
        "compose_dir": SERVICES_DIR / "demucs-api",
        "container_name": "demucs-api",
        "port": 8193,
        "health_endpoint": "/health",
        "auth_type": None,
        "gpu_id": 0,
...
GPU_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    # --- Profils Audio APIs ---
    "audio_api_whisper": {
        "description": "Whisper API only (faster-whisper, 4GB VRAM)",
        "services_up": ["whisper-api"],
        "services_down": ["comfyui-qwen", "comfyui-video", "vllm-zimage", "demucs-api"],
        "gpu_0_usage": "whisper-api (4GB) sur RTX 3080 Ti",
        "gpu_1_usage": "libre",
    },
    "audio_api_tts": {
        "description": "TTS API only (Kokoro, 2GB VRAM)",
        "services_up": ["tts-api"],
        "services_down": ["forge-turbo", "musicgen-api"],
        "gpu_0_usage": "libre",
        "gpu_1_usage": "tts-api (2GB) sur RTX 3090",
    },
    "audio_api_music": {
        "description": "MusicGen API only (6GB VRAM)",
        "services_up": ["musicgen-api"],
        "services_down": ["forge-turbo", "tts-api"],
        "gpu_0_usage": "libre",
        "gpu_1_usage": "musicgen-api (6GB) sur RTX 3090",
    },
    "audio_api_demucs": {
        "description": "Demucs API only (4GB VRAM)",
        "services_up": ["demucs-api"],
        "services_down": ["comfyui-qwen", "comfyui-video", "whisper-api", "vllm-zimage"],
        "gpu_0_usage": "demucs-api (4GB) sur RTX 3080 Ti",
        "gpu_1_usage": "libre",
    },
    "audio_all_apis": {
        "description": "Toutes les APIs Audio (switching GPU 0/1)",
        "services_up": ["whisper-api", "tts-api"],
        "services_down": ["comfyui-qwen", "comfyui-video", "forge-turbo", "vllm-zimage", "musicgen-api", "demucs-api"],
        "gpu_0_usage": "whisper-api (4GB) sur RTX 3080 Ti",
        "gpu_1_usage": "tts-api (2GB) sur RTX 3090",
    },
}
