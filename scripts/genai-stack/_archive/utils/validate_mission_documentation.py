...
# - Superseded by : none (DOUBLON EXACT de core/validate_mission_documentation.py)
# - Verdict recorded in : scripts/genai-stack/_archive/ARCHIVE_README.md + PR #13749 tranche 2A (c.1127)
#
# Per-function disposition :
# - DocumentationValidator : doublon exact avec core/validate_mission_documentation.py ; aucun des deux n'est appelé depuis un script actif -- dead-end
