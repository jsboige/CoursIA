...
# c.1331+97: run_pt11b.py lives NEXT TO this chain runner (scripts/PostTraining/PT-11b/),
...
def run_seed(seed: int) -> tuple[int, float]:
    ...
    # c.1331+84-L2: use sys.executable (conda env python), NOT literal "python"
    # which resolves to system Python and fails (rc=2 in ~1s, no trl/torch).
    # Inherit full env so CUDA_VISIBLE_DEVICES + conda paths propagate.
    import os as _os
