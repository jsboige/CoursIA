...
FP_CASES = [
    ...
    ("MyIA.AI.Notebooks/SymbolicAI/Tweety/Tweety-07a-Extended-Frameworks-CSharp.ipynb", 27, 3, "stderr Tweety-7a Dung via lib"),
    ("MyIA.AI.Notebooks/SymbolicAI/Tweety/Tweety-07a-Extended-Frameworks-CSharp.ipynb", 30, 3, "stderr Tweety-7a Weighted via lib"),
    ("MyIA.AI.Notebooks/SymbolicAI/Tweety/Tweety-07a-Extended-Frameworks-CSharp.ipynb", 33, 6, "stderr Tweety-7a Social via lib"),
]
