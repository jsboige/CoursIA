...
# ---------------------------------------------------------------------------
# Artifact filter — covers _should_skip / _iter_notebooks (consolidated from
# scripts/tests/test_detect_ascii_workaround.py per #10066 sub-grain 1/3).
# Pins the SC-17 stale-artifact fix (c.597 forensic finding #6843): in this
# repo, _output papermill artifacts are filename SUFFIXES (158 *_output.ipynb
# files, 0 _output/ dirs), not directories. The legacy tests for these were
# duplicated in scripts/tests/ and never ported to the canonical home.
# ---------------------------------------------------------------------------
