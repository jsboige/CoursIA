...
FOUNDING_PARAGRAPH = (
    ...
    "bayesien ([`Infer/`](Infer/README.md)) couvre le socle numerote 1-19 "
    "(le numero 6 n'existe pas : le debugging vit en accretion `Infer-2b`), "
    "l'accretion de premier modele `Infer-1b`, et l'application autonome "
    "`Infer-20` *Quotients et fibres* en kernel Python (desormais dans "
    "`Applications/`) "
