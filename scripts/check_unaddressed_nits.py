...
def _formal_concern_precedes_lift(body: str) -> bool:
    ...
    #12908 — le verdict de l'organe B.0 (« **BLOCKED** », « BLOCKED  PR »)
    complete les verdicts formels de review : une revalidation qui maintient
    le blocage en gras PUIS narrate la levée attendue (« une levée explicite
    sur le head final ») n'est pas une levée — l'ordre relatif reste le
    discriminateur.
    """
