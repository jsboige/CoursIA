"""c.8258 verifier: post-reorder invariants for Voting-Methods-Csharp.ipynb."""
import json

NB_PATH = r"MyIA.AI.Notebooks/GameTheory/SocialChoice/03-Voting-Methods-Csharp.ipynb"
BEFORE = r"C:\Users\jsboi\AppData\Local\Temp/c8258_voting_before.json"
