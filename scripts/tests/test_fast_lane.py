...
def test_tranche2_guards_are_absorbed_and_declare_their_warn_rc():
    ...
    assert len(TRANCHE2) == 5, (
        ...
        "gardes (trois instances du ratchet autonome : failure-text, "
        "output-flood puis output-collapse advisory, #14959/#15327) ; si le "
        "nombre change, le commentaire du registre et ce test suivent")
