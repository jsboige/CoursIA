...
- **IA Générative** (chapitre 7) : `GenAI/` (20 Image + 31 Audio + 22 Video + 30 Texte = 103 notebooks, intégrations OpenAI/Anthropic/Semantic Kernel/Qwen). Entrée : [Texte-1_OpenAI_Intro](https://github.com/jsboige/CoursIA/blob/main/MyIA.AI.Notebooks/GenAI/Texte/01_OpenAI_Intro.ipynb)
